...
urlpatterns = [
    ...
    path('solicitud/crearM', createMonitoring.createMonitoring, name="createMonitoring"),
    path('solicitud/seleccionarTipo', selectTypePetition.selectTypePetition, name="selectTypePetition"),
    ...
    path('solicitud/rechazar/<int:petitionId>/', rejectPetition.rejectPetition, name="rejectPetition"),
    path('solicitud/detalles/<int:petitionId>/', showPetition.showPetition, name="showPetition"),
    path('solicitud/eliminar/<int:petitionId>', deletePetition.deletePetition, name="deletePetition"),
    path('solicitud/observacion/crear/<int:petitionId>', createObservation.createObservation , name="createObservation"),
    ...
    path('solicitud/tareasPredeterminadas/eliminar/<int:taskId>', deleteTaskPredeterminate.deleteTaskPredeterminate, name="deleteTaskPredeterminate"),
    path('solicitud/tareas/<int:petitionId>', viewTask.viewTask, name="viewTask"),
    path('solicitud/tareas/crear/<int:petitionId>', createTask.createTask, name="createTask"),
    path('solicitud/tareas/editar/<int:petitionId>/<int:taskId>', editTask.editTask, name="editTask"),
    path('solicitud/tareas/eliminar/<int:taskId>', deleteTask.deleteTask, name="deleteTask"),
    path('solicitud/tareas/actualizar/<int:petition_id>/', updateTasks.updateTasks, name='update_tasks'),
    path('solicitud/tabla/sinAsignar', viewPetitionWithoutUser.viewPetitionWithoutUser, name="viewPetitionWithoutUser")] + static(settings.MEDIA_URL, document_root=settings.MEDIA_ROOT)
