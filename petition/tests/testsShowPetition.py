...
class testsShowPetition(TestCase): 
    ...
    def testShowPetitionOtherExists(self):
        ...
        response = self.client.get(reverse('showPetition', kwargs={'petitionId': self.otherWithUser.pk}))
    ...
    def testShowPetitionOtherWithoutUserExists(self):
        # Hacer una solicitud GET a la vista con una solicitud de Other existente
        response = self.client.get(reverse('showPetition', kwargs={'petitionId': self.otherWithoutUser.pk}))
    ...
    def testShowPetitionMonitoringExists(self):
        ...
        response = self.client.get(reverse('showPetition', kwargs={'petitionId': self.monitoringWithUser.pk}))
    ...
    def testShowPetitionWithoutLogin(self):
        ...
        response = unauthenticatedClient.get(reverse('showPetition', kwargs={'petitionId': self.otherWithoutUser.pk}))
